...
export function Dashboard() {
	...
	const { items, pastItems } = useShoppingCartContext();
	...
	return (
		<Container>
			...
			{/* Quick Actions */}
			<QuickActions>
				<Button variant="primary" onClick={() => navigate("/create-cart")}>
									...
									<CartContent>
										<CartLeft>
											...
											<CartDetails>
												...
												<CartMeta>{cart.itemCount} itens</CartMeta>
											</CartDetails>
										</CartLeft>
										<CartRight>
							...
							>
								<CartContent>
									<CartLeft>
										...
										<CartDetails>
											<CartName>{cart.name}</CartName>
											<CartMeta>{cart.itemCount} itens • Finalizada</CartMeta>
										</CartDetails>
									</CartLeft>
									<CartRight>
										<CartTotal>${cart.total.toFixed(2)}</CartTotal>
