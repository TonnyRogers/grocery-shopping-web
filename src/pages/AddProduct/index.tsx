...
export function AddProduct() {
  ...
  const handleAddProduct = () => {
    ...
    edit(cartId, {
      itemCount: Number(items.find((cartItem) => cartItem.id === cartId)?.itemCount) + numQuantity,
      total: Number(items.find((cartItem) => cartItem.id === cartId)?.total)  + (numQuantity * numPrice),
    })
    ...
    <Container>
      ...
      <Content>
        <ProductIconContainer>
          <ProductIcon>
            <Package style={{ height: '40px', width: '40px', color: 'white' }} />
          </ProductIcon>
        </ProductIconContainer>
            ...
            {quantity && price && (
              <TotalPreview>
                <TotalPreviewContent>
                  ...
                  <TotalValue>
                    ${(parseInt(quantity || "0") * parseFloat(price || "0")).toFixed(2)}
                  </TotalValue>
                </TotalPreviewContent>
              </TotalPreview>
            )}
