    ...
    <Container>
      ...
      <Content>
              ...
              {activeCarts.map((cart) => (
                ...
                >
                  <CartContent>
                    <CartLeft>
                      <ActiveCartIcon>
                        <ShoppingCart style={{ height: '24px', width: '24px', color: 'hsl(var(--primary))' }} />
                      </ActiveCartIcon>
                      <CartInfo>
            ...
            {completedCarts.map((cart) => (
              ...
              >
                <CartContent>
                  <CartLeft>
                    <CompletedCartIcon>
                      <ShoppingCart style={{ height: '24px', width: '24px', color: 'hsl(var(--success))' }} />
                    </CompletedCartIcon>
                    <CartInfo>
                      <CartName>{cart.name}</CartName>
                      <CartStatus>
        ...
        {filteredCarts.length === 0 && (
          <EmptyState>
            <EmptyStateIcon>
              <ShoppingCart style={{ height: '40px', width: '40px', color: 'hsl(var(--muted-foreground))' }} />
            </EmptyStateIcon>
            <EmptyStateTitle>
